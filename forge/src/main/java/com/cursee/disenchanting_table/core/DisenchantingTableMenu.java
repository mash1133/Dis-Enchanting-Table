...
public class DisenchantingTableMenu extends AbstractContainerMenu {
    ...
    public DisenchantingTableMenu(int containerID, Inventory inventory, BlockEntity entity, ContainerData data) {
        super(DisenchantingTableForge.DISENCHANTING_TABLE_MENU.get(), containerID);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, entity.getBlockPos()), pPlayer, DisenchantingTableForge.DISENCHANTING_TABLE_BLOCK.get());
    }
